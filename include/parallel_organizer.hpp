...
struct parallel_organizer
{
    ...
    //      double sum = 0;
    //      parallel_organizer()( 
    //                            [&sum]( size_t i, size_t j )
    //                            {
    //                              sum += std::sum(&arr[i], &arr[j], double() );  
    //                            },
    //                            0, arr.size(),
    //                          );
    template< typename Function >
    void
    operator() ( Function f, size_type index_first, size_type index_last ) const 
    {
        const size_type length          = index_last - index_first;
        if ( 0 == length ) return; // return if input range empty
        ...
        size_type block_first           = index_first;
        size_type block_last            = index_first;
    ...
    void
    operator() ( Function f, Itor first, Itor last ) const 
    {
    ...
    //                            arr1.begin(), arr1.end(), arr2.begin(), back_iserter(ans), 
    //                            return_tag<void>()
    //                          );
    //      double acc = std::accumulate( ans.begin(), ans.end() );
    template< typename Itor1, typename Itor2, typename Function >
    void 
    operator() ( Function f, Itor1 first1, Itor1 last1, Itor2 first2, return_tag<void> ) const 
    {
    ...
    Otor 
    operator() ( Function f, Itor1 first1, Itor1 last1, Itor2 first2, Otor out ) const 
    {
